...
var HrDashboard = AbstractAction.extend({
    ...
    jsLibs: [
     ...
     events: {
        ...
        "click .o_travel_icon": function() {
            this.$('.o_travel_icon').attr("disabled", "disabled");
            this.start_work_trip();
        },
            "click .o_travel_icon_end": function() {
            this.$('.o_travel_icon_end').attr("disabled", "disabled");
            this.end_work_trip();
        },
    ...
    start_work_trip: function () {
        ...
        this._rpc({
                ...
                args: [[self.login_employee.id],'start',this.$( ".reasons" ).val()]
            })
            .then(function(result) {
    ...
    end_work_trip: function () {
        ...
        this._rpc({
                model: 'hr.employee',
                method: 'update_work_trip',
                args: [[self.login_employee.id],'end',this.$( ".reasons" ).val()]
            })
            .then(function(result) {
                var trip_state =self.login_employee.trip_state;
                var message = ''
