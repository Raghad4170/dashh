...
class KsDashboardmtnTemplate(models.Model):
    _name = 'ks_dashboard_mtn.board_defined_filters'
    _description = 'Dashboard mtn Defined Filters'

    name = fields.Char("Filter Label")
    ks_dashboard_board_id = fields.Many2one('ks_dashboard_mtn.board', string="لوحة المعلومات")
    ...
    ks_domain = fields.Char(string="المجال", help="Define conditions for filter. ")
    ...
    ks_is_active = fields.Boolean(string="نشط")
...
class KsDashboardmtnTemplate(models.Model):
    _name = 'ks_dashboard_mtn.board_custom_filters'
    _description = 'Dashboard mtn Custom Filters'
