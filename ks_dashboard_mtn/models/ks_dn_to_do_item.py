...
class KsDashboardmtnItems(models.Model):
    _inherit = 'ks_dashboard_mtn.item'
    ...
    ks_header_bg_color = fields.Char(string="لون خلفية الرأس", default="#8e24aa,0.99",
...
class KsToDoheaders(models.Model):
    ...
    ks_dn_item_id = fields.Many2one('ks_dashboard_mtn.item')
