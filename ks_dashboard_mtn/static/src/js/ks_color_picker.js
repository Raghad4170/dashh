odoo.define('ks_dashboard_mtn_list.ks_color_picker', function(require) {
    "use strict";
    ...
    var KsColorPicker = AbstractField.extend({
        ...
        jsLibs: [
            '/ks_dashboard_mtn/static/lib/js/spectrum.js'
        ],
        cssLibs: [
            '/ks_dashboard_mtn/static/lib/css/spectrum.css',
        ],
