odoo.define('ks_dashboard_mtn.ks_dashboard', function(require) {
    "use strict";

    var core = require('web.core');
    const { patch } = require('web.utils');
    const { WebClient } = require("@web/webclient/webclient");
//    var export = require('ks_dashboard_mtn.import_button');
    ...
    var KsGlobalFunction = require('ks_dashboard_mtn.KsGlobalFunction');

    var KsQuickEditView = require('ks_dashboard_mtn.quick_edit_view');


    var KsDashboardmtn = AbstractAction.extend({
        ...
        jsLibs: [
            ...
            '/ks_dashboard_mtn/static/lib/js/chartjs-plugin-datalabels.js',
            '/ks_dashboard_mtn/static/lib/js/pdfmake.min.js',
            '/ks_dashboard_mtn/static/lib/js/vfs_fonts.js',
        ],
        cssLibs: ['/ks_dashboard_mtn/static/lib/css/Chart.css',
            '/ks_dashboard_mtn/static/lib/css/Chart.min.css'
        ],
...
//            css_grid = $('.o_rtl').length>0 ?
            ...
            this.form_template = 'ks_dashboard_mtn_template_view';
        ...
        ksOnDashboardExportClick: function(ev){
           ...
           var dashboard_id = JSON.stringify(this.ks_dashboard_id);
                ...
                self.getSession().get_file({
                    url: '/ks_dashboard_mtn/export/dashboard_json',
                    data: {
            ...
            return this._super().then(function(){
                self.call('bus_service', 'onNotification', self, function (notifications) {
                    _.each(notifications, (function (notification) {
                        if (notification.hasOwnProperty('type') && notification['type'].type === "ks_dashboard_mtn.notification" && self.ks_mode ==='active') {
...
//                result = self.normalize_dn_data(result);
        ...
        ksRenderDashboard: function() {
            var self = this;
            self.$el.empty();
            self.$el.addClass('ks_dashboard_mtn d-flex flex-column');
            ...
            var $ks_header = $(QWeb.render('ksDashboardmtnHeader', {
        ...
        onAddItemTypeClick: function(e) {
            ...
            if (e.currentTarget.dataset.item !== "ks_json") {
                self.do_action({
                    ...
                    view_id: 'ks_dashboard_mtn_list_form_view',
                    views: [
                        [false, 'form']
                    ],
                    target: 'current',
                    context: {
                        ...
                        'form_view_ref': 'ks_dashboard_mtn.item_form_view',
...
//                            framework.unblockUI();
        ...
        _onKsSaveLayoutClick: function() {
            ...
            if (dashboard_title != false && dashboard_title != 0 && dashboard_title !== self.ks_dashboard_data.name) {
                ...
                var model = 'ks_dashboard_mtn.board';
                ...
                if(this.ks_dashboard_data.ks_selected_board_id && this.ks_dashboard_data.ks_child_boards){
                    ...
                    if (this.ks_dashboard_data.ks_selected_board_id !== 'ks_default'){
                        model = 'ks_dashboard_mtn.child_board';
            ...
            if (dashboard_title ==="") {
                ...
                this._rpc({
                    ...
                    args: ['create', self.ks_dashboard_id, {
                        ...
                        "ks_dashboard_mtn_id": self.ks_dashboard_id,
                        "name": dashboard_title,
                        "ks_active": true,
       ...
       var self = this;
        ...
        _ksSaveCurrentLayout: function() {
            var self = this;
            var grid_config = self.ks_get_current_gridstack_config();
            var model = 'ks_dashboard_mtn.child_board';
        ...
        onKsDuplicateItemClick: function(e) {
            ...
            this._rpc({
                ...
                args: [parseInt(ks_item_id), {
                    'ks_dashboard_mtn_board_id': parseInt(dashboard_id)
                }],
            }).then(function(result) {
...
//                  self.ksUpdateDashboardItem()
        ...
        ksChartExportXlsCsv: function(e) {
            ...
            this.getSession().get_file({
                url: '/ks_dashboard_mtn/export/' + e.currentTarget.dataset.format,
                data: {
                    data: JSON.stringify(data)
                },
                complete: framework.unblockUI,
        ...
        ksItemExportJson: function(e) {
            ...
            framework.blockUI();
            this.getSession().get_file({
                url: '/ks_dashboard_mtn/export/item_json',
                data: {
                    data: JSON.stringify(data)
                },
                complete: framework.unblockUI,
    ...
    core.action_registry.add('ks_dashboard_mtn', KsDashboardmtn);
