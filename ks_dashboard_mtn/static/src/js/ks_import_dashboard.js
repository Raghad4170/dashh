odoo.define('ks_dashboard_mtn.import_button', function(require) {
...
//    var Sidebar = require('web.Sidebar');
    ...
    ListController.include({
       ...
       _getActionMenuItems: function (state) {
        ...
        if (this.modelName == "ks_dashboard_mtn.board"){
    ...
    core.action_registry.add('ks_dashboard_mtn.import_button', ListController);
