odoo.define('ks_dashboard_mtn.quick_edit_view', function(require) {
    "use strict";
    ...
    var QuickEditView = Widget.extend({
        ...
        _ksCreateController: function() {
            ...
            self.context['form_view_ref'] = 'ks_dashboard_mtn.item_quick_edit_form_view';
            self.context['res_id'] = this.item.id;
            self.res_model = "ks_dashboard_mtn.item";
